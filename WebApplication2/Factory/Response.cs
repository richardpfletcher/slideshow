...
namespace Stories.Factory
{
    ...
    public class coupon
    {
        ...
        public string TitleCoupon { get; set; }
        public string Comments { get; set; }

        public string DishID { get; set; }
        public string PictureCoupon { get; set; }
    ...
    public class CouponList
    {
        [XmlArray("coupon")]
        [XmlArrayItem("coupon")]
        public List<coupon> couponLists { get; set; }
        public CouponList()
        {
            couponLists = new List<coupon>();
        }
    }
    ...
    public class response
    {
        ...
        public IList AddCouponList(CouponList list)
        {
            data.Add(list);
            return data;
        }
